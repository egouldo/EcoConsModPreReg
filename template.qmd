...
abstract: |
  ...
  For non-trivial modelling studies, especially where model parameter and structure is in any way data-contingent, we recommend taking an *[Adaptive Preregistration](https://egouldo.github.io/EcoConsPreReg/)* approach [@Gould2026a]. Please read the [*Primer on Adaptive Preregistration*](https://egouldo.github.io/EcoConsPreReg/adaptive_preregistration_background.html) before beginning.
  ...
  *Acknowledgements:* We thank DEECA-ARI workshop participants for their valuable time in helping develop this template.
keywords:
  - preregistration
...
The preregistration item below follows a protocol for registering 'flexible' analyses, please see our ['Primer on Adaptive Preregistration'](https://egouldo.github.io/EcoConsPreReg/adaptive_preregistration_background.html) in Gould et al. -@Gould2026a for details.
:::
