...
authors: # Replace with authors in your study 
  ...
  - name: Hannah Fraser
    ...
    roles: [contributor, conceptualization, methodology, supervision, editing]
    affiliations:
      - ref: 1
  - name: Libby Rumpff
...
abstract: |
  ...
  For non-trivial modelling studies, especially where model parameter and structure is in any way data-contingent, we recommend taking an *Adaptive Preregistration* approach [@Gould2024a].
  Replace author, author-affiliations, keywords, title and abstract metadata as relevant to your study.
  All preregistration items should be completed unless marked as optional, or are not applicable to your study.
keywords: 
  - preregistration
...
-   [ ] "We plan to make the code available (yes / no)," specify the planned code availability level from the following options:
    ...
    -   Code access via secure code center (no download, usage/analysis only in a secure code center)
